# Кредиты / Credits — SkinTotem

## Авторство

**Darkz** — Автор мода, архитектура, рендер, логика загрузки скинов
...
💛 **KlashRaick** — автор мода за идею, поддержку и веру в проект с самого начала.
