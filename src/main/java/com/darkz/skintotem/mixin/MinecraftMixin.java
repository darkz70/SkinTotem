...
public class MinecraftMixin {
	...
	private void addSTHelloScreen(Minecraft client, RealmsClient realmsClient, ReloadInstance resourceReload, QuickPlayData quickPlay, Operation<Void> original) {
