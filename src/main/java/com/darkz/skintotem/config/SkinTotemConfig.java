...
public class SkinTotemConfig {
	...
	public static final Codec<SkinTotemConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			option("standard_doll_model_data", SkinTotemModel.TWO_D_MODEL_ID, ResourceLocation.CODEC, SkinTotemConfig::getStandardSkinTotemModelValue),
			...
			option("auto_refresh_interval_minutes", 10, Codec.INT, SkinTotemConfig::getAutoRefreshIntervalMinutes)
	...
	private ResourceLocation standardSkinTotemModelValue;
